...
import 'package:bittrex_app/routes/app_router.dart';
  ...
  void tappedMenuButton(BuildContext context, String key)  {
    ...
    if (key != "custom" && key != "function-call" && key != "fixed-trans") {
      ...
      Routes.router
          ...
          .then((result) {
        if (key == "pop-result") {
          Routes.router.navigateTo(context, "/demo/func?message=$result");
        }
      });
      ...
      Routes.router.navigateTo(context, "/demo/func?message=$message");
    }
  }
}
