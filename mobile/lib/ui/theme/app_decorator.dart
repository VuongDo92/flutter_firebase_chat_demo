...
class TextStyleOption {
  ...
  static TextStyle textGreyBlueBody4({FontFamily fontFamily}) => TextStyle(
      fontFamily: fontFamily.toString() ?? FontFamily.Lato.toString(),
      color: AppColors.greyBlue,
      fontSize: 13,
      fontWeight: FontWeight.w700);

  static TextStyle textGreyBlueLabel1({FontFamily fontFamily}) => TextStyle(
        fontFamily: fontFamily.toString() ?? FontFamily.Lato.toString(),
        color: AppColors.greyBlue,
        fontSize: 12,
      );
  ...
  static TextStyle textGrayFouroBody2(
          {FontFamily fontFamily = FontFamily.Lato}) =>
      TextStyle(
        fontFamily: getStringFromEnum(fontFamily),
        color: AppColors.grayFour,
